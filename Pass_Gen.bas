...
' Define full compile command line options !
' Put your exact options needed :  FBC.EXE will be the one defined in CSED_FB
'     without the .bas file, it will be added for you
'  change following line according your needs but be precise !
_:[CSED_COMPIL_CMDLINE]:  -x "Pass_Gen.exe" -s gui -v "Pass_Gen.rc" > "Pass_Gen.log" 2>&1
